                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-1 bg-slate-800/50 rounded-3xl p-8 flex flex-col items-center justify-center text-center border border-white/10">
                            ...
                            <div className="flex items-center gap-2 text-slate-400">
                                <Users size={20} />
                                <span className="text-slate-400">{players.length} waiting</span>
                            </div>
                        </div>
    ...
    if (gameState === 'game_over' || gameState === 'GAME_OVER') {
        return (
            <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6">
                ...
                {/* Optional: Show Final Leaderboard here if available */}
                <div className="bg-gray-800 p-6 rounded-xl w-full max-w-2xl mb-8 shadow-2xl">
                    <h2 className="text-2xl text-center mb-4">Final Results</h2>
                    {/* Insert Leaderboard Component or simple list here */}
                ...
                <div className="flex gap-6">
                    ...
                    <button
                        onClick={() => navigate('/')}
                        className="bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-8 rounded-full transition transform hover:scale-105 shadow-lg"
                    >
                        🚪 Exit to Home
                    </button>
                </div>
